			...
			<main class="main-content">
				<div class="container">
					<div class="page">
						...
						<form method="post" action="analysis3.php">
            <div class="input-group">
              <br><br>
              <label>Comment:</label>
              <br>
              <textarea class="form-control" rows="5" columns="20" name="cmt" value="<?php echo $cmt;?>"></textarea>
            </div>
        <br><br>
        <button type="" class="btn" name="comment3">SUBMIT</button>
</form>
					</div>
				</div> <!-- .container -->
			</main>
